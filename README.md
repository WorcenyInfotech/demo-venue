# 🌿 Green Land Farm — Luxury Wedding Venue Website
...
NEXT_PUBLIC_SITE_NAME=Green Land Farm
...
git init
git add .
git commit -m "Initial commit: Green Land Farm website"
...
*Built with ❤️ for Green Land Farm — Surat's Luxury Wedding Venue*
