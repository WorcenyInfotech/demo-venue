  ...
  },
  {
    ...
    cta: (
      <a
        ...
        className="inline-flex items-center gap-1 mt-2 text-xs font-semibold text-[#1a5c2e] hover:text-[#c9a84c] transition-colors"
      >
        Call Now →
      </a>
    ),
            ...
            {CONTACT_ITEMS.map((item, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex items-start gap-4 p-5 bg-white rounded-xl border border-[#c9a84c]/15 shadow-sm hover:shadow-md hover:border-[#c9a84c]/30 transition-all duration-300"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-[#0f3d1e] text-sm mb-1">{item.title}</div>
