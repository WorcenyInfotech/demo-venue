      ...
      {isLoading && (
        ...
        >
          ...
          <div className="relative flex flex-col items-center px-6">
            ...
            >
              <h1 className="font-display text-2xl font-semibold text-ink sm:text-3xl">{VENUE_IDENTITY.name}</h1>
              <p className="mt-1 text-xs font-semibold uppercase tracking-[0.35em] text-rose-gold">{VENUE_IDENTITY.tagline}</p>
            </motion.div>
