      ...
      >
        <div className="overflow-hidden rounded-2xl border border-rose-gold/15 bg-white/95 shadow-luxury backdrop-blur-md">
          <div className="border-b border-rose-gold/10 bg-gradient-to-r from-blush/80 to-cream px-8 py-10 text-center">
            ...
            <h1 className="mt-5 font-display text-2xl font-semibold text-ink">Green Land Farm</h1>
        ...
        <p className="mt-8 text-center text-xs text-ink/55">
          First time? Run <code className="rounded bg-blush px-1.5 py-0.5 text-rose-gold-deep">POST /api/admin/seed</code> to
