          ...
          <div className="mt-10 space-y-10">
            {[
              ...
              },
              {
                title: "Force Majeure",
                content:
                  "Green Land Farm shall not be liable for any failure to perform its obligations due to circumstances beyond its reasonable control, including natural disasters, government restrictions, or other force majeure events.",
              },
              {
                title: "Contact",
                content:
