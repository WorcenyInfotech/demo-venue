...
import { VENUE_IDENTITY, VENUE_CONTACT, VENUE_MAP, PAGE_HERO_IMAGES } from "@/data/venueData";
import {
  Phone,
  Mail,
  MapPin,
...
export const metadata: Metadata = {
  title: `Contact Us | ${VENUE_IDENTITY.name} - Book Wedding Venue ${VENUE_CONTACT.city}`,
  description: `Contact ${VENUE_IDENTITY.name} to book ${VENUE_CONTACT.city}'s most luxurious wedding venue. Call ${VENUE_CONTACT.phone}, email us, or fill out our inquiry form. Free site visits available.`,
  alternates: { canonical: "/contact" },
  openGraph: {
    title: `Contact ${VENUE_IDENTITY.name} | Book Wedding Venue ${VENUE_CONTACT.city}`,
    description: `Get in touch to book your dream wedding at ${VENUE_IDENTITY.name}, ${VENUE_CONTACT.city}. Call, WhatsApp, or fill our inquiry form.`,
    url: "/contact",
  },
};
  ...
  return (
    <>
      <PageHero
        title="Contact"
        titleHighlight="Us"
        subtitle="We'd love to hear from you. Reach out to plan your perfect wedding at Ramayan Farm."
